...
{
	static char *function = "libodraw_notify_set_stream";
...
int libodraw_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libodraw_notify_stream_open";
...
int libodraw_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libodraw_notify_stream_close";
